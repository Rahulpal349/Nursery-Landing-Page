        ...
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            <Link to="/" className="logo" style={{ textDecoration: 'none' }}>
              <img src="/logo_green.png" alt="Srijoni Nursery" style={{ height: '70px', objectFit: 'contain', marginBottom: '15px' }} />
            </Link>
          ...
          <div className="footer-col contact-col">
            ...
            <div className="contact-list">
              ...
              <a href="https://www.srijoninursery.com" target="_blank" rel="noopener noreferrer" className="contact-item">
                ...
                <span>www.srijoninursery.com</span>
              </a>
            </div>
          </div>
